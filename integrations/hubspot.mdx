...
Click the **Create a private app** button to start setting up your connection.
...
**Required scopes are shown in the first screenshot (bereiken.png).** Make sure to select all the necessary permissions for contacts, companies, deals, and appointments.

#### 5. Copy Your Access Token

After creating the app, HubSpot will generate your Private App Access Token. It will start with `pat-na1-...`
